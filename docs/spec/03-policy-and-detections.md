...
2. **SPEC-0001 / PRD-0001 documents are not in the repo.** Trust-envelope and
   taint-floor code cites `SPEC-0001 §N` / `PRD-0001 MN` throughout, but no
   `docs/rfc/SPEC-0001*` file exists at HEAD; the citations are code-comment
   anchors only. `transparency_log.py` cites **SPEC-0002 §5.4** and is an explicit
   stub (see SPEC-04).
